...
public class GeneralPractitioner extends Doctor implements Displayable {
    ...
    // Initialization logic moved to field defaults using constants
    private Boolean walkinAvailable = DEFAULT_WALKIN;
    private Boolean homeVisitAvailable = DEFAULT_HOME_VISIT;
    private Boolean vaccinationCertified = DEFAULT_VACCINATION;
